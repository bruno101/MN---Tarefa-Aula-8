...
NC_F_P3::NC_F_P3(Funcao* integrando, double a, double b, int particao_ou_precisao, int numero_de_particoes, double precisao) {
...
double NC_F_P3::integracao(Funcao *fun, double a1, double b1) {
...
double NC_F_P3::integrarP(int n) {
